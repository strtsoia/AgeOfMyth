...
public class GameSetting {
	...
	private GameSetting() {
		...
		Bank.getInstance();
		/*
		 * for(int index = 0; index < numOfPlayer; index++) players[index] = new
		 * Culture(playerCulture[index]);
		 */

		/*****************************************************************************/
		/*
		 * // print out information for each plaery's initial resource for(int
		 * index = 0; index < numOfPlayer; index++) {
		 * Hashtable<GlobalDef.Resources, Integer> res =
		 * players[index].getGameBoard().getHoldResource();
		 * 
		 * Set<GlobalDef.Resources> kset = res.keySet();
		 * Iterator<GlobalDef.Resources> iter = kset.iterator();
		 * 
		 * while(iter.hasNext()) { GlobalDef.Resources r = iter.next();
		 * System.out.println(r + "   :" + res.get(r)); } }
		 * 
		 * // show initial bank information Hashtable<GlobalDef.Resources,
		 * Integer> res = Bank.getInstance().getResourcePool();
		 * Set<GlobalDef.Resources> kset = res.keySet();
		 * Iterator<GlobalDef.Resources> iter = kset.iterator();
		 * 
		 * while(iter.hasNext()) { GlobalDef.Resources r = iter.next();
		 ...
		 * 
		 * // initial stage System.out.println("initial stage: " +
		 * players[0].getCurrentAge()); Card c = NextAgeCard.GetInstance();
		 * c.Action(players[0]); System.out.println("After paly nexage card: " +
		 * players[0].getCurrentAge());
		 ...
		 * 
		 * while(it.hasNext()) { GlobalDef.Resources r = it.next();
		 * System.out.println(r + "   :" + res.get(r)); }
		 * 
		 * // show initial bank information res =
		 * Bank.getInstance().getResourcePool(); kset = res.keySet();
		 * Iterator<GlobalDef.Resources> iter1 = kset.iterator();
		 * 
		 * while(iter1.hasNext()) { GlobalDef.Resources r = iter1.next();
		 * System.out.println("After next age card, the res in bank   :" +
		 * res.get(r)); }
		 */
	}
