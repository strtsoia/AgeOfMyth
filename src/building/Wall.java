...
public class Wall extends Building{
	...
	public void Behavior(Culture c)
	{
		...
		ResourceHandler.Delete(c.getGameBoard().getHoldResource(), Wall.GetInstance().getCost());
		ResourceHandler.Add(Bank.getInstance().getResourcePool(), Wall.GetInstance().getCost());
	}
