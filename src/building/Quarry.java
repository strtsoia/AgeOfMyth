...
public class Quarry extends Building{
	...
	public void Behavior(Culture c)
	{
		...
		ResourceHandler.Delete(c.getGameBoard().getHoldResource(), Quarry.GetInstance().getCost());
		ResourceHandler.Add(Bank.getInstance().getResourcePool(), Quarry.GetInstance().getCost());
	}
