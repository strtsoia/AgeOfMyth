...
public class Garnary extends Building{
	...
	public void Behavior(Culture c)
	{
		...
		ResourceHandler.Delete(c.getGameBoard().getHoldResource(), Garnary.GetInstance().getCost());
		ResourceHandler.Add(Bank.getInstance().getResourcePool(), Garnary.GetInstance().getCost());
	}
